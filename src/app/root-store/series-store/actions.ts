...
// load pizzas
export const LOAD_SERIES = '[Products] Load Series';
export const LOAD_SERIES_FAIL = '[Products] Load Series Fail';
export const LOAD_SERIES_SUCCESS = '[Products] Load Series Success';
